...
export const FEATURES: Feature[] = [
  ...
  { id: 'app.grok',        phase: 4, label: 'Ask Grok app',          desc: 'General voice assistant on grok-4.5: ask aloud, the answer is shown and read back with each word highlighted as spoken; play/pause, stop, restart buttons.' },
